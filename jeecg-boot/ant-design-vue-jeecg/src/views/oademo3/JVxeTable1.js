        ...
        return h('j-vxe-toolbar', {
          ...
          on: {
            ...
            remove: () => {
              ...
              console.log(this.selectedRowIds.length)
              console.log(this.filterNewRows(this.selectedRowIds))
...
/*              if (deleteRows.length > 0) {
              ...
              if (this.selectedRowIds.length <= 0) {
                ...
                var ids = "";
                ids = this.filterNewRows(this.selectedRowIds);
                var that = this;
                that.loading = true;
                console.log(ids)
                deleteAction(deleteBatch, {ids: ids}).then((res) => {
                  if (res.success) {
