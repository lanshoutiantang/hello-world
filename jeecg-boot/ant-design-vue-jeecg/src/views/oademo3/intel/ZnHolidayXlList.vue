...
<!--                <a-input placeholder="请输入小类编码" v-model="queryParam.xlid"></a-input>-->
    ...
    <zn-holiday-xl-modal ref="modalForm" @ok="modalFormOk"></zn-holiday-xl-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/intel/znHolidayXl/list",
          delete: "/intel/znHolidayXl/delete",
          deleteBatch: "/intel/znHolidayXl/deleteBatch",
          exportXlsUrl: "/intel/znHolidayXl/exportXls",
          importExcelUrl: "intel/znHolidayXl/importExcel",
