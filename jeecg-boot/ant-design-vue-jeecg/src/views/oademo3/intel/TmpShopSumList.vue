...
<!--              </a>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" v-has="'xiaoshou:download'" icon="download" @click="handleExportXls('按日期门店总销售')">导出</a-button>
    ...
    <tmp-shop-sum-modal ref="modalForm" @ok="modalFormOk"></tmp-shop-sum-modal>
  </a-card>
</template>
...
<script>
  ...
  import TmpShopSumModal from './modules/TmpShopSumModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/intel/tmpShopSum/list",
            huizong: "/intel/tmpShopSum/shopSumlist",
          delete: "/intel/tmpShopSum/delete",
          deleteBatch: "/intel/tmpShopSum/deleteBatch",
          exportXlsUrl: "/intel/tmpShopSum/exportXls",
          importExcelUrl: "intel/tmpShopSum/importExcel",
