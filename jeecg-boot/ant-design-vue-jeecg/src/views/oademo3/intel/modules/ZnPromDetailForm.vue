    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="促销开始日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择促销开始日期" :disabled="isDisabledAuth('cuxiao:bukebianji')" v-decorator="['begindate']" :trigger-change="true"  style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="促销结束日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择促销结束日期" :disabled="isDisabledAuth('cuxiao:bukebianji')" v-decorator="['enddate']" :trigger-change="true"  style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
...
<!--              <a-input v-decorator="['shopid']" :disabled="isDisabledAuth('cuxiao:bukebianji')" placeholder="请输入门店编码"></a-input>-->
          ...
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="部类编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-search-select-tag v-decorator="['blid']" :disabled="isDisabledAuth('cuxiao:bukebianji')"  dict="blcode_name,blname,blid" />
              <!--              <a-input v-decorator="['blid']" placeholder="请输入部类编码"></a-input>-->
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="课类编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-search-select-tag v-decorator="['cgid']" :disabled="isDisabledAuth('cuxiao:bukebianji')"  dict="klcode_name,klname,klid" />
          ...
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="小类编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['xlid']" :disabled="isDisabledAuth('cuxiao:bukebianji')" placeholder="请输入小类编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="补货标识" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" :disabled="isDisabledAuth('cuxiao:bukebianji')" v-decorator="['flag']" :trigger-change="true" dictCode="flag1" placeholder="请选择补货标识"/>
<!--              <a-input v-decorator="['flag']" :disabled="isDisabledAuth('cuxiao:bukebianji')" placeholder="请输入补货标识"></a-input>-->
          ...
          <a-col :span="24">
            <a-form-item  label="更新日期时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择更新日期时间" :disabled="isDisabledAuth('cuxiao:bukebianji')" v-decorator="['sdate']" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="部类机构编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['blOrgan']" v-has="'cuxiao:code'" placeholder="请输入部类机构编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="课类机构编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['klOrgan']" v-has="'cuxiao:code'" placeholder="请输入课类机构编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="部类全部机构编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['blOrganAll']" v-has="'cuxiao:code'" placeholder="请输入部类全部机构编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item v-has="'cuxiao:code'" label="课类机构编码"  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['klOrganAll']" v-has="'cuxiao:code'" placeholder="请输入课类全部机构编码"></a-input>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'planid','planname','begindate','enddate','shopid','blid','cgid','xlid','goodsid','goodsname','price','planqty','flag','manualFlag','sdate','shopOrgan','blOrgan','klOrgan','blOrganAll','klOrganAll'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'planid','planname','begindate','enddate','shopid','blid','cgid','xlid','goodsid','goodsname','price','planqty','flag','manualFlag','sdate','shopOrgan','blOrgan','klOrgan','blOrganAll','klOrganAll'))
      },
    }
  }
</script>