...
<!--          "[ 'selectedRole', validatorRules.selectedRole]"-->
...
<!--        "[ 'checkedDepartNameString', validatorRules.checkedDepartNameString]"-->
      ...
      return {
        ...
        validatorRules:{
          ...
          telephone: {
            ...
            selectedRole:{rules: [{ required: true, message: '请选择角色!' }]},
            checkedDepartNameString:{rules: [{ required: true, message: '请选择部门!' }]},
        },
        departIdShow:false,
        departIds:[], //负责部门id
        title:"操作",
