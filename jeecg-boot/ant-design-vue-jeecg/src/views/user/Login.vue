...
<!--    <user-passw ref="userPassw" @success="loginSelectOk"></user-passw>-->
<!--    <user-passwo ref="userPasswo" @success="loginSelectOk"></user-passwo>-->
    <user-passw ref="userPasswo"></user-passw>
...
<script>
  ...
  import UserPassw from "../../components/tools/UserPassw.vue";
                  ...
                  this.$nextTick(() => {
                      ...
                      getAction("/sys/user/firstUpdatePassword").then((res)=>{
                          ...
                          if(res[1] == '123456'){
                              ...
                              this.$refs.userPassw.show(res[0])
                          }else {
