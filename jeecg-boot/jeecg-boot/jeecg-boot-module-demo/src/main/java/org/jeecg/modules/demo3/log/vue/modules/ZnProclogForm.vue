  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'updatetime','shopid','comments','createBy','createTime','updateBy','updateTime','sysOrgCode'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'updatetime','shopid','comments','createBy','createTime','updateBy','updateTime','sysOrgCode'))
      },
    }
  }
</script>