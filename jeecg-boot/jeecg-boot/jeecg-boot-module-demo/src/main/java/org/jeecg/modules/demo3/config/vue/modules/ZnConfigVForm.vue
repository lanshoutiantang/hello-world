        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="商品编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['shopid']" placeholder="请输入商品编码"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="roundRule" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['roundRule']" placeholder="请输入roundRule"></a-input>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'shopid','venderid','classtype','orderdate','weekflag','safedays','arrivaldays','startweek','roundRule'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'shopid','venderid','classtype','orderdate','weekflag','safedays','arrivaldays','startweek','roundRule'))
      },
    }
  }
</script>