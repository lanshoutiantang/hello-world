...
public class ZnHolidayGoodsController extends JeecgController<ZnHolidayGoods, IZnHolidayGoodsService> {
	...
	@PermissionData(pageComponent = "oademo3/intel/ZnHolidayGoodsList")
	...
	public Result<?> edit(@RequestBody ZnHolidayGoods znHolidayGoods) {
	 ...
	 public List<String> getGoodsname(@RequestBody ZnHolidayGoods znHolidayGoods) {


		 String xlid = znHolidayGoods.getXlid();
		 System.out.println("1111");
//		 znHolidayGoods.setGoodsNameList();
//		 znHolidayGoodsService.updateById();
//		 znHolidayGoods.setGoodsNameList(znHolidayGoodsService.getGoodsNameList(xlid));
		 List<String> name=znHolidayGoodsService.getGoodsNameList(xlid);
		 String jjj = JSON.toJSONString(name);
