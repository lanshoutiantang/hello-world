  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'shopid','shopname','goodsid','name','conversion','minorderqty','minstockqty'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'shopid','shopname','goodsid','name','conversion','minorderqty','minstockqty'))
      },
    }
  }
</script>