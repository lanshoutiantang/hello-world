...
<!--      </a-form>-->
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" v-has="'cuxiao:download1'"  @click="handleExportXls('zn_prom_goods8')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            <a v-has="'cuxiao:delete1'" class="ant-dropdown-link">更多 <a-icon type="down" /></a>
            <a-menu slot="overlay">
              <a-menu-item>
    ...
    <znPromGoods8-modal ref="modalForm" @ok="modalFormOk"></znPromGoods8-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZnPromGoods8Modal from './modules/ZnPromGoods8Modal'
  ...
  export default {
    ...
    data () {
      return {
        description: 'zn_prom_goods8管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/intel8/znPromGoods8/list",
          delete: "/intel8/znPromGoods8/delete",
          deleteBatch: "/intel8/znPromGoods8/deleteBatch",
          exportXlsUrl: "/intel8/znPromGoods8/exportXls",
          importExcelUrl: "intel8/znPromGoods8/importExcel",
        },
        dictOptions:{},
      }
    },
