...
import org.jeecg.modules.demo3.config.entity.ZnConfig;
import org.jeecg.modules.demo3.config.service.IZnConfigService;
...
@Api(tags="门店主要补货参数")
@RestController
@RequestMapping("/config/znConfig")
@Slf4j
public class ZnConfigController extends JeecgController<ZnConfig, IZnConfigService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-分页列表查询")
	@ApiOperation(value="门店主要补货参数-分页列表查询", notes="门店主要补货参数-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-添加")
	@ApiOperation(value="门店主要补货参数-添加", notes="门店主要补货参数-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-编辑")
	@ApiOperation(value="门店主要补货参数-编辑", notes="门店主要补货参数-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-通过id删除")
	@ApiOperation(value="门店主要补货参数-通过id删除", notes="门店主要补货参数-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-批量删除")
	@ApiOperation(value="门店主要补货参数-批量删除", notes="门店主要补货参数-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "门店主要补货参数-通过id查询")
	@ApiOperation(value="门店主要补货参数-通过id查询", notes="门店主要补货参数-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, ZnConfig znConfig) {
        return super.exportXls(request, znConfig, ZnConfig.class, "门店主要补货参数");
    }
