...
public class ZnPromPlan implements Serializable {
...
//    @ApiModelProperty(value = "促销开始日期时间")
    @Excel(name = "促销开始日期", width = 20, format = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
...
//    @ApiModelProperty(value = "促销结束日期时间")
    @Excel(name = "促销结束日期", width = 20, format = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "促销结束日期")
    private Date enddate;
    /**状态*/
//    @Excel(name = "状态", width = 15, dicCode = "flag2")
