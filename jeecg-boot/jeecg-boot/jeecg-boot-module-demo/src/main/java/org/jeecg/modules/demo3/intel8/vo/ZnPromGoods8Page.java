package org.jeecg.modules.demo3.intel8.vo;
 ...
 */
@Data
@ApiModel(value="zn_prom_goodsPage对象", description="zn_prom_goods8")
public class ZnPromGoods8Page {
...
//	@Excel(name = "autoId", width = 15)
	...
	@ExcelCollection(name="zn_prom_detail8")
	@ApiModelProperty(value = "zn_prom_detail8")
	private List<ZnPromDetail8> znPromDetail8List;
