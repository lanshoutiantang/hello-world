package org.jeecg.modules.demo3.intel8.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="zn_prom_goods对象", description="zn_prom_goods8")
@Data
@TableName("zn_prom_detail")
public class ZnPromDetail8 implements Serializable {
