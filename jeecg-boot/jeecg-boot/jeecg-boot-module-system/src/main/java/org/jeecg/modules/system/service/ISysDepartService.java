...
public interface ISysDepartService extends IService<SysDepart>{
     ...
     * @param sysDepart
     */
    void saveDepartData(SysDepart sysDepart,String username,String orgCodeValue);
    ...
    String getParentOrgCode(String pId);

    String getDepartName(String pId);

    String getOrgCode(String chuName);

    String getParentId(String chuName);
