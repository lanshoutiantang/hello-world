...
//					String classtype = (String) PropertyUtils.getSimpleProperty(searchObj, "classtype");
//					String flag = (String) PropertyUtils.getSimpleProperty(searchObj, "flag");
//					if(name.equals("classtype") || name.equals("flag") ){
//
//					if(name.equals("classtype") && classtype != null && classtype != "" ){
...
//						queryWrapper.in("classtype",arrayList1);
//					}
//						if (name.equals("flag") && flag != null && flag != "") {
...
//							queryWrapper.in("flag", arrayList);
//						}
//
